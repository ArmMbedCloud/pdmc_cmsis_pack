...
* Changed the default DTLS Fragmentation to 1024 for Wi-SUN Mesh.
* Removed application dependency for int64 printf support which is not present in nanolib-C library.

## Release 4.4.0 (XX.XX.2020)

* Replaced Icetea-based test framework and tests with the Pelion E2E Test Library v0.2.3.
* Updated to Mbed OS 5.15.1.
* Added sleep callback function on application to indicate when client goes to sleep when using `MBED_CLOUD_CLIENT_TRANSPORT_MODE_UDP_QUEUE` mode.
